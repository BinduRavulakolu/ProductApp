...
public class ProductControllerTest {
	...
	/*
	 * @Test public void testAddProductJsonObject() throws Exception {
	 * 
	 * when(productService.addProduct(Mockito.isA(Product.class))) .thenReturn(new
	 * Product(1234, "xxxx", "yyyy", 123.0));
	 * 
	 * String content =
	 * "{\"productId\": 1234, \"productName\": \"xxxx\",\"productCategory\": \"yyyy\",  \"productPrice\": 123.0}"
	 * ;
	 * 
	...
	/*
	 * @Test public void testFindProductById() throws Exception{
	 * 
	 * 
	 * when(productService.findProductById(1234)).thenReturn(new Product(1234,
	 * "xxxx", "yyyy", 123.0));
	 * 
	 * 
	 * mockMvc.perform(MockMvcRequestBuilders.get("/product/1234").accept(MediaType.
	...
	public void testUpdateproduct() throws Exception {
		...
		when(productService.updateProduct(Mockito.isA(Product.class)))
				.thenReturn(new Product(1234, "xyz", "xxx", 1234.0));
		...
		mockMvc.perform(put("/product").contentType(MediaType.APPLICATION_JSON).content(content)
				...
				.andExpect(jsonPath("$.productId").value(1234)).andExpect(jsonPath("$.productName").value("xyz"))
	...
	public void testDeleteproduct() throws Exception {
		...
		verify(productService, times(1)).deleteProduct(1234);
	}
